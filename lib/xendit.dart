...
class Xendit {
  ...
  createCustomer(String reference_id, String phone_number, String email,
      String given_names,
  ...
  createQrCode(String external_id, String type, String callback_url,
      {Map? parameters}) async {
    parameters ??= {};
    return await request("qr_codes",
        parameters: {
  ...
  createVirtualAccounts(String name, String bank_code, String external_id,
      {bool is_closed = false,
      int expected_amount = 0,
      Map? parameters}) async {
    parameters ??= {};
    return await request("callback_virtual_accounts",
        parameters: {
          "name": name,
          "bank_code": bank_code,
          "external_id": external_id,
  ...
  changeVirtualAccounts(String id, Map? parameters) async {
    return await request("callback_virtual_accounts/$id",
        parameters: parameters, methodRequest: "patch");
  }
}
