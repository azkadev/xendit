...
class ExpireInvoice {
  ...
  List<ExpireInvoiceAvailableBanks> get available_banks {
    try {
  ...
  List<ExpireInvoiceAvailableRetailOutlets> get available_retail_outlets {
    try {
  ...
  List<ExpireInvoiceAvailableEwallets> get available_ewallets {
    try {
  ...
  List<ExpireInvoiceAvailableQrCodes> get available_qr_codes {
    try {
  ...
  static ExpireInvoice create({
    ...
    String? expiry_date,
    String? invoice_url,
    List<ExpireInvoiceAvailableBanks?>? available_banks,
    List<ExpireInvoiceAvailableRetailOutlets?>? available_retail_outlets,
    List<ExpireInvoiceAvailableEwallets?>? available_ewallets,
    List<ExpireInvoiceAvailableQrCodes?>? available_qr_codes,
    ...
    jsonCreate.forEach((key, value) {
      try {
        ...
        print("ExpireInvoice ${e.toString()}, ${stack.toString()}");
      }
    });
    return ExpireInvoice(jsonData);
  }
...
class ExpireInvoiceAvailableBanks {
  Map rawData;
  ...
  static ExpireInvoiceAvailableBanks create({
    String? bank_code,
    ...
    Map jsonData = ExpireInvoiceAvailableBanks.defaultData;
    Map jsonCreate = {
      "bank_code": bank_code,
...
class ExpireInvoiceAvailableRetailOutlets {
  Map rawData;

  ExpireInvoiceAvailableRetailOutlets(this.rawData);
  ...
  static ExpireInvoiceAvailableRetailOutlets create({
    String? retail_outlet_name,
  }) {
    Map jsonData = ExpireInvoiceAvailableRetailOutlets.defaultData;
    Map jsonCreate = {
...
class ExpireInvoiceAvailableEwallets {
  Map rawData;

  ExpireInvoiceAvailableEwallets(this.rawData);
  ...
  static ExpireInvoiceAvailableEwallets create({
    String? ewallet_type,
  }) {
    Map jsonData = ExpireInvoiceAvailableEwallets.defaultData;
    Map jsonCreate = {
...
class ExpireInvoiceAvailableQrCodes {
  Map rawData;

  ExpireInvoiceAvailableQrCodes(this.rawData);
  ...
  static ExpireInvoiceAvailableQrCodes create({
    String? qr_code_type,
  }) {
    Map jsonData = ExpireInvoiceAvailableQrCodes.defaultData;
    Map jsonCreate = {
...
class ExpireInvoiceCustomerNotificationPreference {
  Map rawData;
  ...
  static ExpireInvoiceCustomerNotificationPreference create({
    List<Object?>? invoice_created,
    List<Object?>? invoice_reminder,
    List<Object?>? invoice_expired,
    List<Object?>? invoice_paid,
  }) {
    Map jsonData = ExpireInvoiceCustomerNotificationPreference.defaultData;
    Map jsonCreate = {
