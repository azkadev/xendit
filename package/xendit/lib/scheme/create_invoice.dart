...
class CreateInvoice {
  ...
  List<CreateInvoiceAvailableBanks> get available_banks {
    try {
      if (rawData["available_banks"] is List == false) {
        return [];
      }
      return (rawData["available_banks"] as List).map((e) => CreateInvoiceAvailableBanks(e as Map)).toList().cast<CreateInvoiceAvailableBanks>();
    } catch (e) {
      return [];
    }
  }

  List<CreateInvoiceAvailableRetailOutlets> get available_retail_outlets {
    try {
      if (rawData["available_retail_outlets"] is List == false) {
        return [];
      }
      return (rawData["available_retail_outlets"] as List).map((e) => CreateInvoiceAvailableRetailOutlets(e as Map)).toList().cast<CreateInvoiceAvailableRetailOutlets>();
    } catch (e) {
      return [];
    }
  }

  List<CreateInvoiceAvailableEwallets> get available_ewallets {
    try {
      if (rawData["available_ewallets"] is List == false) {
        return [];
      }
      return (rawData["available_ewallets"] as List).map((e) => CreateInvoiceAvailableEwallets(e as Map)).toList().cast<CreateInvoiceAvailableEwallets>();
    } catch (e) {
      return [];
    }
  }

  List<CreateInvoiceAvailableQrCodes> get available_qr_codes {
    try {
      if (rawData["available_qr_codes"] is List == false) {
        return [];
      }
      return (rawData["available_qr_codes"] as List).map((e) => CreateInvoiceAvailableQrCodes(e as Map)).toList().cast<CreateInvoiceAvailableQrCodes>();
    } catch (e) {
      return [];
    }
  }
  ...
  CreateInvoiceCustomerNotificationPreference get customer_notification_preference {
    try {
      if (rawData["customer_notification_preference"] is Map == false) {
        return CreateInvoiceCustomerNotificationPreference({});
      }
      return CreateInvoiceCustomerNotificationPreference(rawData["customer_notification_preference"] as Map);
    } catch (e) {
      return CreateInvoiceCustomerNotificationPreference({});
    }
  }
  ...
  static CreateInvoice create({
    ...
    String? expiry_date,
    String? invoice_url,
    List<CreateInvoiceAvailableBanks?>? available_banks,
    List<CreateInvoiceAvailableRetailOutlets?>? available_retail_outlets,
    List<CreateInvoiceAvailableEwallets?>? available_ewallets,
    List<CreateInvoiceAvailableQrCodes?>? available_qr_codes,
    ...
    String? updated,
    String? currency,
    CreateInvoiceCustomerNotificationPreference? customer_notification_preference,
  }) {
    Map jsonData = CreateInvoice.defaultData;
    Map jsonCreate = {
      "@type": special_type,
      "id": id,
    ...
    jsonCreate.forEach((key, value) {
      try {
        ...
        print("CreateInvoice ${e.toString()}, ${stack.toString()}");
      }
    });
    return CreateInvoice(jsonData);
  }
...
class CreateInvoiceAvailableBanks {
  Map rawData;

  CreateInvoiceAvailableBanks(this.rawData);
  ...
  static CreateInvoiceAvailableBanks create({
    String? bank_code,
    ...
    Map jsonData = CreateInvoiceAvailableBanks.defaultData;
    Map jsonCreate = {
      "bank_code": bank_code,
    ...
    jsonCreate.forEach((key, value) {
      try {
        ...
        print("CreateInvoiceAvailableBanks ${e.toString()}, ${stack.toString()}");
      }
    });
    return CreateInvoiceAvailableBanks(jsonData);
  }
...
class CreateInvoiceAvailableRetailOutlets {
  Map rawData;

  CreateInvoiceAvailableRetailOutlets(this.rawData);
  ...
  static CreateInvoiceAvailableRetailOutlets create({
    String? retail_outlet_name,
  }) {
    Map jsonData = CreateInvoiceAvailableRetailOutlets.defaultData;
    Map jsonCreate = {
    ...
    jsonCreate.forEach((key, value) {
      try {
        ...
        print("CreateInvoiceAvailableRetailOutlets ${e.toString()}, ${stack.toString()}");
      }
    });
    return CreateInvoiceAvailableRetailOutlets(jsonData);
  }
...
class CreateInvoiceAvailableEwallets {
  Map rawData;

  CreateInvoiceAvailableEwallets(this.rawData);
  ...
  static CreateInvoiceAvailableEwallets create({
    String? ewallet_type,
  }) {
    Map jsonData = CreateInvoiceAvailableEwallets.defaultData;
    Map jsonCreate = {
    ...
    jsonCreate.forEach((key, value) {
      try {
        ...
        print("CreateInvoiceAvailableEwallets ${e.toString()}, ${stack.toString()}");
      }
    });
    return CreateInvoiceAvailableEwallets(jsonData);
  }
...
class CreateInvoiceAvailableQrCodes {
  Map rawData;

  CreateInvoiceAvailableQrCodes(this.rawData);
  ...
  static CreateInvoiceAvailableQrCodes create({
    String? qr_code_type,
  }) {
    Map jsonData = CreateInvoiceAvailableQrCodes.defaultData;
    Map jsonCreate = {
    ...
    jsonCreate.forEach((key, value) {
      try {
        ...
        print("CreateInvoiceAvailableQrCodes ${e.toString()}, ${stack.toString()}");
      }
    });
    return CreateInvoiceAvailableQrCodes(jsonData);
  }
...
class CreateInvoiceCustomerNotificationPreference {
  Map rawData;

  CreateInvoiceCustomerNotificationPreference(this.rawData);
  ...
  static CreateInvoiceCustomerNotificationPreference create({
    List<Object?>? invoice_created,
    List<Object?>? invoice_reminder,
    List<Object?>? invoice_expired,
    List<Object?>? invoice_paid,
  }) {
    Map jsonData = CreateInvoiceCustomerNotificationPreference.defaultData;
    Map jsonCreate = {
    ...
    jsonCreate.forEach((key, value) {
      try {
        ...
        print("CreateInvoiceCustomerNotificationPreference ${e.toString()}, ${stack.toString()}");
      }
    });
    return CreateInvoiceCustomerNotificationPreference(jsonData);
  }
